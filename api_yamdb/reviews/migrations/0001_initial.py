# Generated by Django 3.2 on 2024-01-31 18:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_confirmation_code', models.CharField(blank=True, max_length=5, verbose_name='Код подтверждения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.IntegerField(default=0, help_text='Год создания', validators=[reviews.validators.validate_year], verbose_name='Год создания')),
                ('description', models.TextField(blank=True, max_length=255, verbose_name='Описание')),
                ('category', models.ForeignKey(blank=True, default='Категория не указана', on_delete=django.db.models.deletion.SET_DEFAULT, related_name='titles', to='reviews.category', verbose_name='Категория')),
